...
void location1(int loc, int c1) {
	...
	case 1:
		...
		break;
	case 2:
		cout << "___________________________________________\nYou went to the closet...it is divided into two compartments, lower and upper\nOpen top 1\nOpen open bottom 2\nLeave 3" << endl;
		cin >> cls1;
		switch (cls1) {
		case 1:
			close1(1);
		...
		break;
	case 3:
		cout << "___________________________________________\nYou came to the door...it's closed\nLeave 1; Open the lock 2" << endl;
		cin >> dr1;
		if (dr1 == 1)
			cycle1(1);
		if (dr1 == 2)
			door1(1);
				break;
	case 4:
		cout << "___________________________________________\nYou looked at the carpet under your feet...\nit seems that there is something under it...but its edges are hammered into the walls...\nInspect 1" << endl;
		cin >> crp1;
		if (crp1 == 1)
			carpter1(1);
			break;
